...
XTroid.addCMD({pattern: 'gm', fromMe: true, deleteCommand: true, desc: GM,}, (async (message, match) => {
    ...
    r_text[1] = "❀🍃Good❀ ❀morning Theruwan saranayi ❀🥰❀";
    r_text[2] ="☘️𝐺𝑜𝑜𝑑 🌅𝑚𝑜𝑟𝑛𝑖𝑛𝑔 Theruwan saranayi 💐";
    r_text[3] ="🍃𝙶𝚘𝚘𝚍 🌻𝚖𝚘𝚛𝚗𝚒𝚗𝚐 Theruwan saranayi 🥰";
    r_text[4] ="🍀𝗚𝗼𝗼𝗱 😘𝗺𝗼𝗿𝗻𝗶𝗻𝗴 Theruwan saranayi 🌸";
    r_text[5] ="🌻𝓖𝓸𝓸𝓭 𝓶𝓸𝓻𝓷𝓲𝓷𝓰 Theruwan saranayi 💞";
    r_text[6] ="🌼🅖🅞🅞🅓 🅜🅞🅡🅝🅘🅝🅖 Theruwan saranayi 🐶";
    r_text[7] ="🍃Ⓖⓞⓞⓓ 🌈ⓜⓞⓡⓝⓘⓝⓖ 🥰";
...
XTroid.addCMD({pattern: 'gn', fromMe: true, deleteCommand: true, desc: GN,}, (async (message, match) => {
        ...
        r_text[1] = "😘𝙂𝙤𝙤𝙙 🙈𝙣𝙞𝙜𝙝𝙩 Theruwan saranayi 💫✨";
        r_text[2] ="🤗𝓖𝓸𝓸𝓭 🧚‍♀𝓷𝓲𝓰𝓱𝓽 Theruwan saranayi ❄️✨";
        r_text[3] ="🌌❡០០ᖱ 🌙⩎ɨ❡ϦƬ Theruwan saranayi 🌎";
        r_text[4] ="😘ցօօժ ⭐️ղíցհԵ Theruwan saranayi 💝";
        r_text[5] ="🌃Ꮐᝪᝪᗞ 🙈ᑎᏆᏀᕼᎢ Theruwan saranayi 💫✨";
